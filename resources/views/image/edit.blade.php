...
<head>
    ...
    <link rel="stylesheet" href="{{env('APP_URL').'css/post.css'}}">
...
<body>
    ...
    <div class="contain">
        <div class="box">
            <form action="{{env('APP_URL'). 'api/image/'. $image->id.'/delete'}}" method="get" id="deleteImageForm">
                <input type="button" id="delete" value="XÓA ẢNH">
            </form>
            <form action="{{env('APP_URL'). 'api/image/'. $image->id.'/edit'}}" method="POST" id="form_post_product">
                ...
                <div class="describe">
                    <div class="infor_product-category-ali">
                        ...
                        <input type="text" name="name" id="Name_product"
                            class="infor_product-category-ali-select " placeholder="Tiêu đề cho ảnh (bắt buộc)" value="{{$image->name}}">
                    ...
                    <div class="infor_product-category-ali">
                        ...
                        <textarea class="infor_product-category-ali-select-describe" inputmode="text"
                            id="Decrip_product" name="detail" placeholder="Nội dung chi tiết" >{{$image->detail}}</textarea>
                        <span class="valid_err_text"></span>
                    </div>

                    <div class="infor_product-export">
                        <input type="submit" class="infor_product-export-btn-text" value="Thay đổi">
                    </div>
                </div>
    ...
    <script src="{{env('APP_URL').'js/post.js'}}"></script>
    <script>
